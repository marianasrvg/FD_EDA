...
void add_vect(Mesh m, float x, float y, float z){
    ...
    m->arrayCord = (COORD*)realloc(m->arrayCord, sizeof(COORD) + 1); //aumentar el tamaño con realloc
...
void add_triangle(Mesh m, int point1, int point2, int point3){
    ...
    printf("(:\n");
    m->arrayTri = (Triangle*)realloc(m->arrayTri, sizeof(Triangle) + 1); //Aumentar el tamaño del arreglo para el nuevo triangulo
    printf("(:\n");
